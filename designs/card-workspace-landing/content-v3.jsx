/* Card Workspace — v3 landing copy.
  ...
  en: {
    ...
    sections: {
      why: {
        ...
        slot: 'Drop a 4:3 crop: two or three cards in the sidebar, with a narrow strip of the editor for context',
      },
      nav: {
        index: '02',
        ...
        slot: 'Drop a 4:3 crop of the navigation column, keeping a narrow strip of the editor visible',
      },
      boxes: {
        index: '03',
      ...
      flow: {
        ...
        slot: 'Drop a 4:3 shot or short clip with the sidebar and the editor both visible',
      },
      scale: {
        index: '05',
  ...
  zh: {
    ...
    sections: {
      why: {
        ...
        slot: '放一张 4:3 卡片特写：侧栏展示两三张卡片，同时保留一小部分编辑区作为环境提示',
      },
      nav: {
        index: '02',
        kicker: '自带导航',
        ...
        slot: '放一张 4:3 导航列截图，让四个分区都可见，并保留一小部分编辑区',
      },
      boxes: {
        index: '03',
        kicker: '真正值得装的那个功能',
      ...
      flow: {
        ...
        slot: '放一张 4:3 截图（或短录屏），让侧栏卡片与编辑器中的拖放目标同时可见',
      },
      scale: {
        index: '05',
        kicker: '为真实体量的库而做',
