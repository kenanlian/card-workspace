/* The v3 landing composition.
   Hero is stacked and centred on the bare canvas; everything after it is a
   stream of indexed cards, each holding the gutter + two-column letterpress
   structure. Feature media is a fixed 4:3 element centred against its copy. */
  ...
  return (
    <div className="cw-page">
      ...
      <div className="cw-wrap cw-stream">
        {/* 01 — the premise */}
        <SectionCard id="why" index={s.why.index} kicker={s.why.kicker} order={0}>
          <div className="cw-sec__text">
            <h2 className="cw-h2 cw-sec__title">{s.why.title}</h2>
        ...
        <SectionCard id="nav" index={s.nav.index} kicker={s.nav.kicker} order={1}>
          <div className="cw-sec__text">
            <h2 className="cw-h2 cw-sec__title">{s.nav.title}</h2>
        ...
        >
          <div className="cw-sec__text">
            <h2 className="cw-h2 cw-sec__title">{s.boxes.title}</h2>
        ...
        >
          <div className="cw-sec__text">
            <h2 className="cw-h2 cw-sec__title">{s.flow.title}</h2>
        ...
        >
          <div className="cw-sec__text">
            <h2 className="cw-h2 cw-sec__title">{s.scale.title}</h2>
        ...
        >
          <div className="cw-sec__text">
            <h2 className="cw-h2 cw-sec__title">{s.install.title}</h2>
