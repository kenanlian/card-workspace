/* Card Workspace — landing copy, single source of truth for all four directions.
   Every claim here is traceable to the plugin's README.md / manifest.json / i18n.ts.
   Anything not yet verifiable is wrapped in TODO[] so it renders as a visible placeholder. */
...
const CONTENT = {
  en: {
    ...
    hero: {
      eyebrow: 'Obsidian plugin · v1.0.2',
      ...
      meta: 'Requires Obsidian 1.9.0 or later',
      metaSoft: 'Desktop today · mobile planned',
      installNote: 'TODO[confirm current install channel — README is out of date]',
      shotCaption: 'Card Workspace open in the left sidebar, navigation pane beside the card stream',
    },
    stats: [
      { value: '4', label: 'nav sections' },
      { value: '4', label: 'drag-insert modes' },
      { value: '0', label: 'network requests' },
      { value: '1.9', label: 'min Obsidian' },
    ],
    sections: {
      why: {
        index: '01',
      ...
      boxes: {
        ...
        slot: 'Drop a shot of a card box being created, or a box with its rules panel open',
      },
      flow: {
        index: '04',
  ...
  zh: {
    ...
    hero: {
      ...
      secondaryCta: '查看文档',
      meta: '需要 Obsidian 1.9.0 或更高版本',
      metaSoft: '当前支持桌面端 · 移动端在计划中',
      installNote: 'TODO[安装方式待确认 —— README 已过时]',
    ...
    sections: {
      ...
      boxes: {
        ...
        slot: '放一张新建卡片盒的截图，或某个卡片盒打开规则面板的样子',
      },
      flow: {
        index: '04',
        kicker: '不打断手上的事',
...
const DIRECTIONS = [
  {
    ...
    nameZh: '纸质索引',
    family: 'warm',
    blurb: 'Warm oatmeal paper, letterpress serif, index-card rules. Quiet and generous.',
    blurbZh: '暖燕麦纸底、印刷体衬线、索引卡横线。安静、留白充足。',
  },
  {
    id: 'letterpress',
    name: 'Letterpress',
    nameZh: '铅字印刷',
    family: 'warm',
    blurb: 'Dense editorial warmth — numbered sections, gutter metadata, terracotta accent.',
    blurbZh: '密集的编辑式暖调——编号小节、栏位元数据、陶土色强调。',
  },
  {
    id: 'graphite',
    name: 'Graphite',
    nameZh: '石墨',
    family: 'cool',
    blurb: 'Cool near-neutral, hairline rings, restrained type. The quietest of the four.',
    blurbZh: '冷调近中性、发丝描边、克制排版。四个方向里最安静的一个。',
  },
  {
    id: 'blueprint',
    name: 'Blueprint',
    nameZh: '蓝图',
    family: 'cool',
    blurb: 'Technical grid with labelled axes, mono micro-labels, high information density.',
    blurbZh: '带标注轴线的技术网格、等宽小标签、高信息密度。',
  },
];

Object.assign(window, { CONTENT, DIRECTIONS });
